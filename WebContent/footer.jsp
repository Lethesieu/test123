...
<body>
		<div class="footer">
			<div class="footer-top">
				<div class="container">
					...
					<div class="col-md-4 footer-in">
						...
						<p>Website được chạy trên nhiều nền tảng, với trụ sở chính ở: 191 Lê Duẩn,Bến Thủy, TP.VINH </p>
					</div>
			...
			<div class="footer-middle">
				<div class="container">
					<div class="footer-middle-in">
						...
						<p>Số 191 Lê Duẩn,Bến Thủy, TP.Vinh
			...
			Web design by LE THE SIEU
			<br>
			&copy;2020 Website sales </p>
